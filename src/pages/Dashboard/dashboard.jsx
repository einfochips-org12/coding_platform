      ...
      {/* <div className="w-64 bg-white border-r">
        <div className="p-4 border-b">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-blue-600 font-bold text-lg">infochips</h1>
          </div>
        </div>
        
        <div className="p-2">
          <div className="flex items-center p-3 mb-2 bg-blue-600 text-white rounded-md">
            <div className="mr-3">
          ...
          <div className="flex items-center p-3 mb-2 text-gray-600 hover:bg-gray-100 rounded-md">
            <div className="mr-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-auto absolute bottom-4 left-4 right-4">
          <div className="flex items-center p-3 border rounded-lg">
            ...
            <div>
              <div className="text-sm font-medium">Meet Talviya</div>
