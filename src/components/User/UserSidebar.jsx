...
export default function Sidebar() {
  ...
  const menuItems = [
    { id: 'dashboard', name: 'Dashboard', icon: Home, path: '/user/dashboard' },
    { id: 'tasks', name: 'Tasks', icon: CheckSquare, path: '/user/category' },
    { id: 'submission', name: 'Submission', icon: Users, path: '/user/submissions' },
    { id: 'exam', name: 'Exam', icon: BookOpen, path: '/user/exam' },
    { id: 'help', name: 'Help', icon: HelpCircle, path: '/user/help' }
  ];
